...
pub fn tokenize(text: &str) -> Vec<Token> {
    #[cfg(feature = "nlp")]
    {
        ...
        return text.unicode_words().map(Token::new).collect();
    }
    #[cfg(not(feature = "nlp"))]
    {
...
fn stem_fallback(word: &str) -> String {
    ...
    const SUFFIXES: &[&str] = &[
        // English
        "ization", "ational", "fulness", "ousness", "iveness", "ing", "ied", "ies", "ied", "ment",
        "ness", "tion", "sion", "able", "ible", "ance", "ence", "ed", "es", "s", "ly", "er", "est",
        // Shqip
        "imit", "imet", "imin", "ueshëm", "shëm", "imi", "eve", "ave", "ojnë", "uar", "ut", "it",
        "in", "ës", "ëve", "të",
    ];
    let w = word;
...
pub fn is_stopword(word: &str) -> bool {
    const STOPWORDS: &[&str] = &[
        ...
        "he", "she", "we", "they", "do", "does", "did", "have", "has", "had", "will", "would",
        "can", "could", // Shqip
        "dhe", "ose", "por", "është", "janë", "ishte", "të", "e", "i", "një", "me", "në", "nga",
        "për", "si", "që", "ky", "kjo", "ai", "ajo", "ne", "ju", "do", "ka", "kanë", "kishte",
        "mund", "u", "se", "këtë", "atë",
    ];
