...
This is an **uncalibrated, maintainer-authored heuristic self-assessment**. It
is a prioritization aid, not an external score, certification, review result,
or predictor of scientific or grant success.
...
| --- | ---: | --- | --- |
| GitHub classification | 90 | Maintainer-observed on 2026-09-14: factual one-sentence description; 20 audited topics; Rust detected as primary language; Apache-2.0; identity consistent in README and metadata | Topic utility needs real search/referral data and periodic review; `formal-methods` requires especially careful boundaries |
...
Arithmetic mean: `(1209 / 15) = 80.60`, reported as **81/100**.
